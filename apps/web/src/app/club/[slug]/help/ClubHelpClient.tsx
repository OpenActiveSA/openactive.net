...
interface ClubHelpClientProps {
  slug: string;
  clubSettings: ClubSettings;
}

function ClubHelpContent({ slug, clubSettings }: ClubHelpClientProps) {
...
export default function ClubHelpClient(props: ClubHelpClientProps) {
  return (
    <ClubAnimationProvider>
      <ClubHelpContent {...props} />
    </ClubAnimationProvider>
  );
}
