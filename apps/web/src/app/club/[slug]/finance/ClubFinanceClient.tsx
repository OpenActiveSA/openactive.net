...
interface ClubFinanceClientProps {
  slug: string;
  clubSettings: ClubSettings;
}

function ClubFinanceContent({ slug, clubSettings }: ClubFinanceClientProps) {
...
export default function ClubFinanceClient(props: ClubFinanceClientProps) {
  return (
    <ClubAnimationProvider>
      <ClubFinanceContent {...props} />
    </ClubAnimationProvider>
  );
}
