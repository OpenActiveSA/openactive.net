...
interface ClubDocumentsClientProps {
  slug: string;
  clubSettings: ClubSettings;
}

function ClubDocumentsContent({ slug, clubSettings }: ClubDocumentsClientProps) {
  ...
  return (
    ...
    >
      <ClubHeader 
        ...
        currentPath={`/club/${slug}/documents`}
      />
...
export default function ClubDocumentsClient(props: ClubDocumentsClientProps) {
  return (
    <ClubAnimationProvider>
      <ClubDocumentsContent {...props} />
    </ClubAnimationProvider>
  );
}
